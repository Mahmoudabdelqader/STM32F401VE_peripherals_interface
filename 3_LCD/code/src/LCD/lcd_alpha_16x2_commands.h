/*
 * lcd_alpha_16x2_commands.h
 *
 *  Created on: Apr 1, 2022
 *      Author: Hoda
 */

#ifndef LCD_LCD_ALPHA_16X2_COMMANDS_H_
#define LCD_LCD_ALPHA_16X2_COMMANDS_H_
...
#define _decrement_cursor					     (0x04)

// >> increment cursor, shift cursor to right.
#define _increment_cursor					     (0x06)
...
#define _display_off_cursor_off				     (0x08)

// >> display on and cursor off.
#define _display_on_cursor_off		  	         (0x0C)

// display on and cursor on, no blinking.
#define _display_on_cursor_on_no_blinking		 (0x0E)

/* display on and cursor blinking*/
#define _display_on_cursor_blinking			     (0x0F)

/* Moves cursor and shifts display without changing DDRAM contents.
 * delay time = 37 us, ~= 40 us*/
// >> Cursor move to the left.
#define _cursor_move_to_the_left					 (0x10)

// >> Cursor move to the right.
#define _cursor_move_to_the_right			     (0x14)

// >> display move to the left.
#define _display_move_to_the_left				 (0x18)

// >> display move to the right.
#define _display_move_to_the_right				 (0x1C)
...
#define _force_cusror_to_start_with_1st_row	     (0x80)

/* beginning to the 2nd line */
/* 0xCn, n = 0:F ==> n is the cursor position. */
#define _force_cusror_to_start_with_2nd_row	     (0xC0)

/* init lcd mode. */
#define __init__							     (0x32)

#endif /* LCD_LCD_ALPHA_16X2_COMMANDS_H_ */
